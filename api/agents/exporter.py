...
h1 { font-size: 22pt; margin: 0 0 10pt; color: #1a2332; font-weight: 600; line-height: 1.2; letter-spacing: -0.01em; border-bottom: 2pt solid #2078a8; padding-bottom: 8pt; }
h2 { font-size: 14pt; margin: 18pt 0 6pt; color: #1a2332; font-weight: 600; padding-bottom: 3pt; border-bottom: 0.75pt solid #c8d4dc; letter-spacing: -0.005em; }
h3 { font-size: 11.5pt; margin: 10pt 0 4pt; font-style: italic; color: #2a3a4a; }
p { margin: 4pt 0 6pt; }
blockquote { border-left: 2.5pt solid #2078a8; padding: 6pt 0 6pt 10pt; color: #2a3a4a; font-style: italic; margin: 10pt 0; background: #f4f8fb; }
code { font-family: 'JetBrains Mono', 'Menlo', monospace; font-size: 9pt; background: #f0eee8; padding: 1pt 3pt; border-radius: 2pt; color: #b87a3d; }
pre { font-family: 'JetBrains Mono', 'Menlo', monospace; font-size: 8.5pt; background: #f0eee8; padding: 6pt; border-radius: 3pt; }
table { width: 100%; border-collapse: collapse; margin: 6pt 0 12pt; font-size: 8.5pt; table-layout: fixed; border: 0.5pt solid #c8d4dc; }
th, td { padding: 5pt 6pt; border-bottom: 0.5pt solid #d8dee4; text-align: left; vertical-align: top; word-wrap: break-word; overflow-wrap: break-word; }
th { background: #2078a8; color: #ffffff; text-transform: uppercase; letter-spacing: 0.08em; font-size: 7.5pt; font-weight: 600; border-bottom: none; }
tr:nth-child(even) td { background: #f8f9fa; }
ul, ol { padding-left: 18pt; margin: 4pt 0 8pt; }
li { margin: 2pt 0; }
strong { color: #1a2332; font-weight: 600; }
em { color: #4a5564; }
a { color: #2078a8; text-decoration: none; border-bottom: 0.5pt solid #2078a8; }
hr { border: none; border-top: 0.5pt solid #c8d4dc; margin: 14pt 0; }
